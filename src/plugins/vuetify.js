...
// Not `@mdi/font/css/materialdesignicons.css`: that is 7,447 icons — a 394KB woff2 and
// 408KB of `content:` rules — for the ~130 this app draws. The generated subset below
// is the same icons at 7KB + 13KB, regenerated by scripts/build-mdi-subset.mjs, which
// `npm run dev` and `npm run build` both chain ahead of vite so it cannot drift.
